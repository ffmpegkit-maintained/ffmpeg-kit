...
#define FFMPEG_CONFIGURATION "--cross-prefix=aarch64-linux-android- --sysroot=/home/runner/.ndk/android-ndk-r26c/toolchains/llvm/prebuilt/linux-x86_64/sysroot --prefix=/home/runner/work/ffmpeg-kit/ffmpeg-kit/prebuilt/android-arm64/ffmpeg --pkg-config=/usr/bin/pkg-config --enable-version3 --arch=aarch64 --cpu=armv8-a --target-os=android --enable-neon --enable-asm --enable-inline-asm --ar=llvm-ar --cc=aarch64-linux-android24-clang --cxx=aarch64-linux-android24-clang++ --ranlib=llvm-ranlib --strip=llvm-strip --nm=llvm-nm --extra-libs='-L/home/runner/work/ffmpeg-kit/ffmpeg-kit/prebuilt/android-arm64/cpu-features/lib -lndk_compat ' --disable-autodetect --enable-cross-compile --enable-pic --enable-jni --enable-optimizations --enable-swscale --disable-static --enable-shared --enable-pthreads --enable-v4l2-m2m --disable-outdev=fbdev --disable-indev=fbdev --enable-small --disable-xmm-clobber-test --disable-debug --enable-lto --disable-neon-clobber-test --disable-programs --disable-postproc --disable-doc --disable-htmlpages --disable-manpages --disable-podpages --disable-txtpages --disable-sndio --disable-schannel --disable-securetransport --disable-xlib --disable-cuda --disable-cuvid --disable-nvenc --disable-vaapi --disable-vdpau --disable-videotoolbox --disable-audiotoolbox --disable-appkit --disable-alsa --disable-cuda --disable-cuvid --disable-nvenc --disable-vaapi --disable-vdpau --enable-libmp3lame --enable-iconv --enable-libtheora --enable-libvorbis --enable-libvpx --enable-libxml2 --enable-libopencore-amrnb --enable-libshine --enable-libspeex --enable-libdav1d --enable-libilbc --enable-libopus --enable-libsnappy --enable-libsoxr --enable-libaom --enable-libtwolame --enable-sdl2 --enable-libvo-amrwbenc --enable-libzimg --disable-openssl --enable-zlib --enable-mediacodec"
#define FFMPEG_LICENSE "LGPL version 3 or later"
#define CONFIG_THIS_YEAR 2023
#define FFMPEG_DATADIR "/home/runner/work/ffmpeg-kit/ffmpeg-kit/prebuilt/android-arm64/ffmpeg/share/ffmpeg"
#define AVCONV_DATADIR "/home/runner/work/ffmpeg-kit/ffmpeg-kit/prebuilt/android-arm64/ffmpeg/share/ffmpeg"
