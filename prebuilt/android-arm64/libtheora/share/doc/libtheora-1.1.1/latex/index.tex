...
This is the documentation for {\ttfamily libtheora} C API. The current reference implementation for {\texttt{ Theora}}, a free, patent-\/unencumbered video codec. Theora is derived from On2\textquotesingle{}s VP3 codec with additional features and integration with Ogg multimedia formats by {\texttt{ the Xiph.\+Org Foundation}}. Complete documentation of the format itself is available in {\texttt{ the Theora specification}}.\doxysubsection{Organization}\label{index_Organization}
